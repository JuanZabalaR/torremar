                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-md-pull-7">
                        <div class="booking-form">
                            <form method="post" action="<?= site_url('search') ?>" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <span class="form-label">Dia de Entrada</span>
                                            <input type="date" class="form-control date" placeholder="Select Date" id="entryDate" name="res_entry">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <span class="form-label">Dia de Salida</span>
                                            <input class="form-control date" type="date" required id="exitDate" name="res_exit">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="cpty">
                                                <option>1</option>
                                                <option>2</option>
                                                <option>3</option>
                                                <option>4</option>
